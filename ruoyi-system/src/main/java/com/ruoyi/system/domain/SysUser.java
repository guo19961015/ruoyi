...
public class SysUser extends BaseEntity
{
    ...
    private String qualificationDisplay;
    private String organizationPicture;

    private String flage;

    private String[] ryProductList;
    ...
    public void setQualificationDisplay(String qualificationDisplay) {
    ...
    public String[] getRyProductList() {
        return ryProductList;
    }

    public void setRyProductList(String[] ryProductList) {
        this.ryProductList = ryProductList;
    }
    ...
    public String toString() {
        return new ToStringBuilder(this,ToStringStyle.MULTI_LINE_STYLE)
            ...
            .append("organizationPicture",getOrganizationPicture())
            .append("ryProductList",getRyProductList())
