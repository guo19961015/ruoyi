...
public interface IProcessService {
    ...
    ProcessInstance submitApplyPlate(String applyUserId, String businessKey, String itemName, String itemConent, String key, Map<String, Object> variables);

    ProcessInstance submitApplyPl(String applyUserId, String businessKey, String title, String legal, String key, Map<String, Object> variables);
    ...
    void completePl(Date realityStartTime, Date realityEndTime, BigDecimal actualLoanAmount, String taskId, String instanceId, String itemName, String itemContent, String module, Map<String, Object> variables, HttpServletRequest request);
    void completePlate(String taskId, String instanceId, String itemName, String itemContent, String module, Map<String, Object> variables, HttpServletRequest request);
    /**
     * 委托任务
     * @param taskId
